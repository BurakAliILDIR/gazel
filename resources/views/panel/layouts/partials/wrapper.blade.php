																...
																<tbody>
																	<tr>
																		<td class="pl-0 py-5">
																			<div class="symbol symbol-50 symbol-light mr-2">
																				<span class="symbol-label">
																					<img src="{{ asset('storage/panel/assets/media/svg/misc/015-telegram.svg') }}"
																	...
																	<tr>
																		<td class="py-5 pl-0">
																			<div class="symbol symbol-50 symbol-light mr-2">
																				<span class="symbol-label">
																					<img src="{{ asset('storage/panel/assets/media/svg/misc/003-puzzle.svg') }}"
                                                                                         class="h-50 align-self-center"
                                                                                         alt="" />
																				</span>
																			</div>
																	...
																	<tr>
																		<td class="py-5 pl-0">
																			<div class="symbol symbol-50 symbol-light mr-2">
																				<span class="symbol-label">
																					<img src="{{ asset('storage/panel/assets/media/svg/misc/005-bebo.svg') }}"
																	...
																	<tr>
																		<td class="py-5 pl-0">
																			<div class="symbol symbol-50 symbol-light mr-2">
																				<span class="symbol-label">
																					<img src="{{ asset('storage/panel/assets/media/svg/misc/006-plurk.svg') }}"
                                                                                         class="h-50 align-self-center"
                                                                                         alt="" />
																				</span>
																			</div>
																	...
																	<tr>
																		<td class="py-5 pl-0">
																			<div class="symbol symbol-50 symbol-light mr-2">
																				<span class="symbol-label">
																					<img src="{{ asset('storage/panel/assets/media/svg/misc/014-kickstarter.svg') }}"
                                                                                         class="h-50 align-self-center"
                                                                                         alt="" />
																				</span>
																			</div>
											...
											<div class="card-header border-0">
												...
												<div class="card-toolbar">
													<div class="dropdown dropdown-inline">
														<a href="#" class="btn btn-light btn-sm font-size-sm font-weight-bolder dropdown-toggle text-dark-75"
										...
										<div class="card card-custom card-stretch">
											...
											<div class="card-body pt-2">
												...
												<div class="d-flex flex-wrap align-items-center mb-10">
                                                    ...
                                                    <!--begin::btn-->
													<span
                                                        class="label label-lg label-light-warning label-inline mt-lg-0 mb-lg-0 my-2 font-weight-bold py-4">In Progress</span>
                                                    <!--end::Btn-->
												</div>
                                                <!--end::Item-->
                                                <!--begin::Item-->
