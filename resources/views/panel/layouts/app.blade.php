...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<head>
		...
		<link href="{{ asset('storage/panel/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css') }}" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed sidebar-enabled page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile header-mobile-fixed">
			<!--begin::Logo-->
			<a href="/">
				<img alt="Logo" src="{{ asset('storage/panel/assets/media/logos/logo-letter-1.png') }}" class="logo-default max-h-30px" />
			</a>
            <!--end::Logo-->
            <!--begin::Toolbar-->
		...
		<div class="d-flex flex-column flex-root">
            ...
            <!--end::Aside-->
                <!--begin::Wrapper-->
            @include('panel.layouts.partials.wrapper')
            <!--end::Wrapper-->
        ...
        <!-- begin::User Panel-->
        @include('panel.layouts.partials.quick_user')
        <!-- end::User Panel-->
		...
		<script src="{{ asset('storage/panel/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js') }}"></script>
		<script src="//maps.google.com/maps/api/js?key=AIzaSyBTGnKT7dt597vo9QgeQ7BFhvSRP4eiMSM"></script>
		<script src="{{ asset('storage/panel/assets/plugins/custom/gmaps/gmaps.js') }}"></script>
        <!--end::Page Vendors-->
        <!--begin::Page Scripts(used by this page)-->
		<script src="{{ asset('storage/panel/assets/js/pages/widgets.js') }}"></script>
        <!--end::Page Scripts-->
	</body>
    <!--end::Body-->
</html>
